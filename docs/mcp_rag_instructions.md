...
1. Использовать инструмент `use_mcp_tool`
2. Указать имя сервера: `McpRag`
3. Выбрать нужный инструмент: `echo` или `index_folder`
4. Передать соответствующие параметры в `arguments`
